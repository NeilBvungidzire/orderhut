...
class OrderSuccess extends React.PureComponent {
  ...
  render() {
    ...
    localStorage.setItem("order._id", order._id);
      ...
      <div className="order-success">
        {isLoading ? (
          ...
          <div className="order-message">
            <h2>
              Thank you for your order proceed with payment to complete your
              order.
            </h2>
            <p>
              Order{" "}
            ...
            <p>
              A confirmation email will be sent to you when you complete the
              payment.
            </p>
